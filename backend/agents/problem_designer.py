...
class ProblemDesigner:
    def connect_topics(self, state: TopicState) -> TopicState:
        ...
        topic_messages = [
            ...
            HumanMessage(
                content=f"Choose topics from the above list that work cohesively with each other, to create a meaningful problem for {course} students"
            ),
        ]
